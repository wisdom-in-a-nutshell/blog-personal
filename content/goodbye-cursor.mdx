...
To my surprise, after throwing a couple of random tasks from different repos at it, Codex just works. It’s minimal, hackable, and I’ve already merged PRs with it. That is probably the ultimate test. Also, this bit is hard to quantify and express, but it feels really nice and delightful to use.
