...
<div className="my-6 flex justify-center">
  <table className="mx-auto w-full max-w-3xl min-w-[28rem] table-fixed overflow-hidden rounded-2xl border border-border/60 bg-card/95 text-sm shadow-sm">
...
<EpisodeLengthTable group="overall" />
...
<EpisodeLengthTable group="daily" />
...
<EpisodeLengthTable group="nearDaily" />
...
<EpisodeLengthTable group="weekly" />
...
<EpisodeLengthTable group="monthly" />
