...
If you use Cursor often, this should sound very familiar. You've likely said similar things yourself. You nudge the AI back towards your project's standards or your personal preferences again and again.

If you already are nodding your head in agreement with what is being said here and the title of this blog post make sense to you and you are just here for the meta cursor rules that you want to use, feel free to jump straight to the section on [How to Create Rules Without the Friction](#how-to-create-rules-without-the-friction).
