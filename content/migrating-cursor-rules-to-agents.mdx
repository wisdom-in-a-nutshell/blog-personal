...
One of the biggest challenges in this transition was migrating all my [Cursor Rules](https://cursor.com/docs/context/rules) to work with [Codex CLI](https://github.com/openai/codex) (basically converting them into nested markdown files called [AGENTS.md](https://agents.md)).
...
When I started migrating away from Cursor to Codex CLI ([here's why](/blog/goodbye-cursor), but in short, cost), my Cursor Rules investment was one of the main sticky factors keeping me there. Every repository I work with has at least six to ten custom rules that define exactly how my agents should behave.

The challenge was keeping all my Cursor rules when switching to [Codex CLI](https://github.com/openai/codex). Obviously I automated it. Let me walk you through how that works.
