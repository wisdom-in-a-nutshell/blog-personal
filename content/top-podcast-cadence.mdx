...
- **Weekly dominates.** 582 shows (58.2%) stick to the 3-9 day rhythm. Shows that drop the same day each week (*This American Life*, comedy chat shows). People know when to expect them.
