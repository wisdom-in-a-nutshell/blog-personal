...
After my last two posts on [how often big shows publish](/blog/top-podcast-cadence) and [how long their episodes run](/blog/how-long-top-podcasts-run), I couldn't stop wondering: who's actually running the infrastructure for these top shows?

But it's not just about who hosts the RSS feed (that's just the storefront). I also wanted to know who's *really* delivering the audio files, because that's where the real power and ad tech is. So I decided to look at both.

Right off the bat, two things jumped out at me:
- Megaphone's lead gets bigger the closer you get to the very top, while Libsyn still owns a huge chunk of the broader top 10k.
- About 1 in 10 of the top shows still use their own domains for their RSS feeds, but there's a clever strategy at play there.
