...
Many people are blindsided by what's happening with LLMs. The progress we're seeing isn't just incremental. It's unlike anything I've seen in my software engineering career. It's moving at remarkable speed. People who haven't directly worked with these systems think it's like going from iPhone 16 to iPhone 17 with minor upgrades.

But in reality, we're seeing transformative leaps in capabilities. From GPT-3 to GPT-4, Claude to Claude 3, and now models like Gemini, we've witnessed fundamental improvements in reasoning, knowledge, and capabilities that weren't possible just a year or two earlier. This isn't gradual evolution. It's more like moving from bikes to cars to jet engines to rockets within a remarkably compressed timeframe.
